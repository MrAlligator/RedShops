        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a href="<?php echo site_url('admin/administrator/add') ?>"><i class="fas fa-plus"></i>  Tambah User</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    <?php foreach ($pengguna as $admin): ?>
                      <tr>
                        ...
                        <td>
                          <a onclick="deleteConfirm('<?php echo site_url('admin/administrator/delete/'.$admin->id_user) ?>')" href="#!" class="btn btn-sm text-danger"><i class="fas fa-trash"></i> Hapus</a></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
