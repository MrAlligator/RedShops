            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="<?php echo base_url('index.php/user/kaos') ?>">Kaos</a></li>
                  <li><a href="<?php echo base_url('index.php/user/jaket') ?>">Jaket</a></li>
                  <li><a href="<?php echo base_url('index.php/user/celana') ?>">Celana</a></li>
