...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('assets/css/custom-scroll/jquery.mCustomScrollbar.css') ?>" rel="stylesheet">
  ...
  <body>
    ...
    <script src="<?php echo base_url('assets/js/carousel-product.js') ?>"></script>
