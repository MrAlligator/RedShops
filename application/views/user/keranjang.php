    ...
    <hr class="offset-md">
        <div class="col-sm-12">
            ...
            <?php endforeach; ?>
                ...
                <tr>
                    <td colspan="2"> </td>
                    <td style="text-align:right" class="right"><h3><strong>Total</strong></h3></td>
                    <td style="text-align:right" class="right"><h3>Rp.<?php echo $this->cart->format_number($this->cart->total()); ?></h3></td>
                </tr>
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <a href="" class="btn btn-primary"><i class="ion-card"></i> Checkout</a>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
